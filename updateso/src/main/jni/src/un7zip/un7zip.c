...
#define FUNC(f) Java_com_moba_unityplugin_Z7Extractor_##f

JNIEXPORT jstring JNICALL
FUNC(GetLzmaVersion)(JNIEnv *env, jclass type) {
    return (*env)->NewStringUTF(env, MY_VERSION_COPYRIGHT_DATE);
}

JNIEXPORT jint JNICALL
FUNC(ExtractFile)(JNIEnv *env, jclass type, jstring filePath_,
...
JNIEXPORT jint JNICALL
FUNC(ExtractAsset)(JNIEnv *env, jclass type, jobject assetManager,
